	...
	var $window = $( window ),
		...
		_createSingleView = function() {
			...
			if( !Gamma.singleview ) {
				...
				$( '<div class="gamma-single-view"><div class="gamma-options gamma-options-single"><div><a href="http://google.com" style="background-color: #555555;color:#fff;margin-left:5px;">Add to cart</a></div><div class="gamma-buttons"><button class="gamma-btn-close"></button></div></div></div>' )
