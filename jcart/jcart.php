	...
	*/
	public function display_cart() {
		...
		if ($isCheckout !== true) {
			...
			echo tab(7) . "<div align='right' style='align:right; padding: 0 30px 0 10px;'><input type='$inputType' $src id='jcart-checkout' name='jcartCheckout' class='jcart-button' value='{$config['text']['checkout']}' /></div>\n";
		}
...
echo tab(3) . "<div align='right' style='align:right; padding: 0 30px 0 10px;'><a href='http://pablofernandez.com/photography/jcart/gateway.php'><input type='button' value='Checkout with PayPal' /></a></div>";
